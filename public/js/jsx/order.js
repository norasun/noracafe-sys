  ...
  var Product = React.createClass({
    ...
    render: function(){
      ...
      return (
        <a className="Product clearfix" href="#" ref="productContent" id={domid}>

          <span className="pull-left">
             {this.props.name}
          </span>

          <button href="#" className="btn btn-default btn-sm pull-right" onClick={this.onClick}  type="submit">加入订单</button>
    ...
    render: function(){
      return (
        <div className="Order clearfix">
          ...
          <a href="#" className="pull-right orderDelete"  onClick={this.orderDelete}><i className="fa fa-minus-circle"></i></a>
