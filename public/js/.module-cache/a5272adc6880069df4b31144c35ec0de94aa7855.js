    ...
    render: function(){
      return (
        React.DOM.div({className: "Order clearfix"}, 
          ...
          React.DOM.span({className: "pull-right mr-20"}, "¥", this.props.price, "元"), 
          React.DOM.a({href: "#", className: "pull-right orderDelete"}, React.DOM.i({className: "fa fa-plus-circle"})), 
          React.DOM.span({className: "pull-right orderNum mr-20"}, this.props.num), 
          React.DOM.a({href: "#", className: "pull-right orderDelete mr-20"}, React.DOM.i({className: "fa fa-minus-circle"}))
