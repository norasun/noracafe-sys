  ...
  var Product = React.createClass({displayName: 'Product',
    ...
    render: function(){
      ...
      return (
        React.DOM.a({className: "Product clearfix", onClick: this.onClick, href: "#", id: domid}, 
    ...
    render: function(){
      if(this.props.show == 'show'){
        ...
        return (
          ...
          React.DOM.div({className: "PreOrder", style: this.props.style}, 
            this.props.name, 
            ...
            React.DOM.button({type: "button", onClick: this.onClick, className: "btn btn-mwm"}, "添加")
          )
        );
      }else{
        return (
