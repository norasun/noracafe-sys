  ...
  var Product = React.createClass({displayName: 'Product',
    onClick: function(e){
      ...
      var preOrderLeft = $('#'+this.refs.productNum.getDOMNode().id).offset().left;
      var preOrderTop = $('#'+this.refs.productNum.getDOMNode().id).offset().top - 2;
      var preOrderWidth = $('#'+this.refs.productNum.getDOMNode().id).outerWidth();
