      ...
      return (
        React.DOM.a({className: "Product clearfix", href: "#", onClick: this.onClick, ref: "productContent", id: domid}, 
          React.DOM.span({className: "pull-left"}, 
            React.DOM.small({className: "text-muted"}, "[ i ]"), " ", this.props.name
          ), 
          React.DOM.button({className: "btn btn-default btn-sm pull-right", type: "submit"}, "加入订单"), 
          ...
          React.DOM.div({className: "col-md-8"}, 
            React.DOM.div({className: "white-container"}, 
              React.DOM.div({className: "mb-15"}, 
                React.DOM.p(null, React.DOM.strong({className: "text-l mr-20"}, "点单"), React.DOM.a({href: "/create_product", className: "btn btn-default btn-xs"}, "添加产品")), 
                React.DOM.p(null, React.DOM.small({className: "text-muted mr-10"}, "此界面由掌柜操作，可以在客人点单时使用此界面录入订单，也可在其他任意时间段把销售情况补录系统。"), 
                React.DOM.a({href: "#", className: "btn btn-default btn-xs"}, "知道了"))
              ), 
