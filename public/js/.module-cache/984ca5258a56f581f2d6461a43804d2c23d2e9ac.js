            ...
            React.DOM.div({className: "white-container"}, 
              React.DOM.div({className: "mb-15"}, 
                React.DOM.p(null, 
                  ...
                  React.DOM.a({href: "/create_product", className: "btn btn-default btn-xs mr-10"}, "新增产品"), 
                  React.DOM.a({href: "/create_product", className: "btn btn-default btn-xs"}, "管理")
                ), 
                React.DOM.p(null, 
                React.DOM.small({className: "text-muted mr-10"}, 
                  "此界面由掌柜操作，可以在客人点单时录入订单，也可在其他任意时间段把销售情况补录系统。", 
                  React.DOM.a({href: "#"}, "[ 学习一下如何规划菜单 ]")
                )
                )
              ), 
