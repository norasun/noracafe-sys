    ...
    render: function(){
      return (
        React.DOM.div({className: "Order clearfix"}, 
          ...
          React.DOM.a({href: "#", className: "pull-right orderDelete mr-20", onclick: this.orderDelete}, React.DOM.i({className: "fa fa-plus-circle"})), 
          React.DOM.span({className: "pull-right orderNum"}, this.props.num, " aaa"), 
