    ...
    render: function(){
      ...
      return (
        React.DOM.a({className: "Product clearfix", href: "#", onClick: this.onClick, ref: "productContent", id: domid}, 
          ...
          React.DOM.span({className: "pull-left mr-10"}, 
             this.props.name
          ), 
          React.DOM.i({className: "fa fa-caret-square-o-down pull-left"}), 
        ...
        React.DOM.div({className: "row"}, 
            ...
            React.DOM.div({className: "white-container"}, 
              React.DOM.div({className: "mb-15"}, 
                ...
                React.DOM.small({className: "text-muted mr-10"}, 
                  "此界面由掌柜操作，可以在客人点单时使用此界面录入订单，也可在其他任意时间段把销售情况补录系统。", 
                  React.DOM.a({href: "#"}, "[ 学习一下 ]")
                )
                )
              ), 
          ...
          React.DOM.div({className: "col-md-4"}, 
            React.DOM.div({className: "black-container"}, 
              React.DOM.div({className: "mb-15"}, 
                React.DOM.strong({className: "text-l mr-20"}, React.DOM.i({class: "fa fa-clipboard"}), "订单")
              ), 
